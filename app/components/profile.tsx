...
function Profile() {
  return (
    <div className="w-full bg-secon flex text-main py-10 pr-5 max-xl:flex-col-reverse gap-8">
      ...
      {/* Avatar Section */}
      <div className=" flex flex-col w-2/6 max-lg:w-full justify-center">
        <div className="relative w-96 h-96 max-lg:w-56 max-lg:h-56 rounded-full flex self-center duration-700">
          <Image
